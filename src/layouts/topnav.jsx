...
//               <Link to="/login" className="btn btn-outline-primary me-2">تسجيل الدخول</Link>
//               <Link to="/login" className="btn btn-primary">انشاء حساب</Link>
//             </div>
//           </div>

//           {/* Offcanvas للقوائم المدمجة (تظهر في الشاشات الصغيرة) */}
//           {/* <div
...
//               <h5 className="offcanvas-title" id="offcanvasNavbarLabel">DREAMFY</h5>
//               <button
//                 type="button"
//                 className="btn-close"
//                 data-bs-dismiss="offcanvas"
...
//                 </li>
//                 <li className="nav-item">
//                   <Link to="/login" className="nav-link">انشاء حساب</Link>
//                 </li>
//                 <li className="nav-item">
